...
#' 
#' @param A Path to the bed file
#' @param B If the bed file is compressed, should the uncompressed file be 
#' retained or removed? Defaults to TRUE.
#' @param C How many lines to skip? Defaults to zero. You must look at the 
